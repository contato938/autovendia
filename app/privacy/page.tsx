        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-8 text-foreground/90 leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                A AutovendaIA ("nós", "nosso") respeita a sua privacidade e está comprometida em proteger os dados pessoais que você compartilha conosco. Esta política descreve como coletamos, usamos e protegemos suas informações ao utilizar nossa plataforma de integração de dados de vendas e marketing.
              </p>
            </section>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground">3. Como Usamos Seus Dados</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground">5. Segurança</h2>
              <p>
